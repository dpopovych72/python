...
# 1) Check if the customer is eligible for any listed categories
# 2) Tell the customer that they are eligible to do something or not 
print("\n")
if age >= drive_age :
...
# The program runs again for some reason if i don't end it with this line
